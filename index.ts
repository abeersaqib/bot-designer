 ...
 import NodeRedRuntime from '@node-red/runtime';
...
console.log('application will be listening on', listenPort);
...
const settings: NodeRedRuntime.LocalSettings = {
    verbose: false,
    httpAdminRoot: "/admin",
    httpNodeRoot: "/",
    userDir: userdir,
...
var template = [{
    ...
    submenu: [
        { label: 'Reload',
            ...
            click(item: any, focusedWindow: { reload: () => void; }) { if (focusedWindow) focusedWindow.reload(); }
        },
        { label: 'Toggle Developer Tools',
            accelerator: process.platform === 'darwin' ? 'Alt+Command+I' : 'Ctrl+Shift+I',
            click(item: any, focusedWindow: { webContents: { toggleDevTools: () => void; }; }) { if (focusedWindow) focusedWindow.webContents.toggleDevTools(); }
        },
        { type: 'separator' },
        { role: 'resetzoom' },
        { role: 'zoomin' },
...
function createWindow() {
    ...
    webContents.on('did-get-response-details', function(event: any, status: any, newURL: string, originalURL: any, httpResponseCode: number) {
    ...
    mainWindow.webContents.on("new-window", function(e: any, url: any, frameName: any, disposition: any, options: { x: any; y: any; width: any; height: any; }) {
